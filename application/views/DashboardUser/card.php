            ...
            <div class="my-3 py-3 text-center"> 
                ...
                <div class="row align-center">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                        <div class="card h-100 bg-secondary text-white card_menu" style="background: linear-gradient(20deg, #6c757d 0, #5e72e4 100%) !important; " >
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                            <div class="card h-100 bg-success text-white card_menu" style="background: linear-gradient(20deg, #28a745  0, #7a5649 100%) !important; ">
                                <div class="card-body my-auto">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                            <div class="card h-100 bg-warning text-white card_menu" style="background: linear-gradient(20deg, #ffc101 0, #923020 100%) !important; ">
                                <div class="card-body my-auto">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                            <div class="card h-100 bg-transparent text-primary card_menu" style="background: linear-gradient(20deg, #5e72e4 0, #133020 100%) !important; ">
                                <div class="card-body my-auto bg-transparent">
                                <i class="icon-user " style="font-size: 48px; color: #fff;"></i>
                                   <h4 class="inner" style="color: #fff; font-size: 16px;">View Profile</h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                        <div class="card h-100 bg-info text-white card_menu" style="background: linear-gradient(20deg, #17a2b8  0, #5e72e4 100%) !important; ">
                            <div class="card-body my-auto" >
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                            <div class="card h-100 bg-muted text-white card_menu" style="background: linear-gradient(20deg, #f4f8fb   0, #c8c8c8 100%) !important; ">
                                <div class="card-body my-auto">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                            <div class="card h-100 bg-dark text-white card_menu" style="background: linear-gradient(20deg, #343a40 0, #c8c8c8 100%) !important; ">
                                <div class="card-body my-auto">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-3 jumps" style="height: 100px; ">
                        <a href="#">
                            <div class="card h-100 bg-danger text-primary card_menu" style="background: linear-gradient(20deg, #dc3545  0, #dfea4d 100%) !important; ">
                                <div class="card-body my-auto bg-transparent">
